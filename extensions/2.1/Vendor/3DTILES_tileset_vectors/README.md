...
> ![](./figures/vector_tiles_and_contents.png)
>
> Geometry crossing tile boundaries should be visually clip the content at the limits of the node's bounding volume.
