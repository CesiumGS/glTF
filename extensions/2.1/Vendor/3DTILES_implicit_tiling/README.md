...
`subtrees`|Template URI for subtree files. See [Subtres](#subtrees).
...
For subdivision of S2 bounding volumes refer to link: [3DTILES_bounding_volume_S2](../3DTILES_bounding_volume_S2/README.md#implicit-subdivision).
