...
This extension uses WGS 84 ([EPSG:4978](https://epsg.org/crs_4978/WGS-84.html)) as the default ellipsoid. A different ellipsoid may be specified with [EXT_crs](../EXT_crs/README.md).
