...
This extension declares the Coordinate Reference System (CRS) in which a glTF 2.1 asset was authored as a [Well-Known Text (version 2)](https://www.ogc.org/standards/wkt-crs/) string.

This extension **MUST** be used with [3DTILES_crs](../3DTILES_crs/README.md).

The following example shows an asset annotated to indicate a UTM Zone 11N coordinate reference system.
...
- `string` is a Well-Known Text string