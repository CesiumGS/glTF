...
`EXT_crs_wkt2` extends the [`EXT_crs`](../EXT_crs/README.md) object. The "format" property **MUST** be `"wkt2"`. The extension defines a single property `"wkt2"` whose value **MUST** be a [Well-Known Text (version 2)](https://www.ogc.org/standards/wkt-crs/) string.
